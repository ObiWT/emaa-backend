...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR(30).nullable(false), this, "");
    ...
    public List<UniqueKey<RoleRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ROLE_CODE_KEY);
    }
