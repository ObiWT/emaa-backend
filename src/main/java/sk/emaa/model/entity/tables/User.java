...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>public.user.school_id</code>.
     */
    public final TableField<UserRecord, Integer> SCHOOL_ID = createField(DSL.name("school_id"), SQLDataType.INTEGER, this, "");
    ...
    public List<ForeignKey<UserRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER__USERS_SCHOOL_ID_FKEY);
    }
    ...
    public SchoolPath school() {
        if (_school == null)
            _school = new SchoolPath(this, Keys.USER__USERS_SCHOOL_ID_FKEY, null);
